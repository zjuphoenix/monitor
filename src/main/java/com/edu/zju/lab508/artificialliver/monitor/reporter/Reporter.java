...
import com.edu.zju.lab508.artificialliver.monitor.domain.*;
...
public class Reporter extends Document {
    ...
    public Reporter(OperationInfo operationInfo, List<Scheme> schemes) throws DocumentException, IOException {
        super(PageSize.A4, 50, 50, 50, 50);
        this.operationInfo = operationInfo;
        this.schemes = schemes;
        this.surgeryNo = operationInfo.operationNo;
        ...
        PdfWriter.getInstance(this, new FileOutputStream("./" + surgeryNo
                + operationInfo.patientName + operationInfo.time + ".pdf"));
        this.open();
    }
    ...
    public void setHeader() throws DocumentException {
        ...
        Paragraph baseInformation = new Paragraph(
                String.format(
                        ...
                        operationInfo.doctor, operationInfo.operationNo,
                        operationInfo.time, operationInfo.operationTime),
                baseFontChinese);
    ...
    public void setCumulantParagraph() throws DocumentException, IOException {
        Cumulant cumulant = pumpSpeedMapper.getCumulant(surgeryNo);
    ...
    public void setLiquidParagraph() throws ParseException, IOException,DocumentException {
        List<LiquidData> liquidDatas = pumpSpeedMapper.getLiquidDatas(surgeryNo);
    ...
    public void setPressureParagraph() throws ParseException, IOException,DocumentException {
        List<PressureData> PressureDatas = pressureMapper.getPressureDatas(surgeryNo);
        DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        TimeSeriesCollection lineDataset = new TimeSeriesCollection();
    ...
    public static void main(String[] args) throws DocumentException,
        ...
        Reporter report = new Reporter(new OperationInfo("张三", "男", "20",
